...
| `taxpayer:correct` | Edit | revenue_officer, admin | `POST /taxpayers/:id/identity`<br>`POST /taxpayers/:id/status` |
...
| `group:manage` | Edit | revenue_officer, admin | `POST /groups/`<br>`POST /groups/:id/review`<br>`POST /groups/:id/members`<br>`POST /groups/:id/members/:membershipId/departure`<br>…and 1 more |
...
| `catalogue:read` | View | agent, supervisor, revenue_officer, finance_officer, auditor, admin | `GET /government/search`<br>`GET /revenue/authorities`<br>`GET /revenue/categories`<br>`GET /revenue/items`<br>…and 1 more |
| `catalogue:configure` | Configure | revenue_officer, admin | `GET /government/audit/queries/rate-changes`<br>`GET /revenue/items`<br>`POST /revenue/items/:id/rates`<br>`POST /revenue/items`<br>…and 1 more |
| `assessment:create` | Create | agent | `POST /revenue/quote`<br>`POST /revenue/assessments` |
...
| `report:read:territory` | View | supervisor | `GET /agents/performance`<br>`GET /government/dashboard`<br>`GET /government/revenue/by-category`<br>`GET /government/revenue/defaulters`<br>…and 5 more |
| `report:read:all` | View | revenue_officer, finance_officer, auditor, admin | `GET /agents/performance`<br>`GET /government/dashboard`<br>`GET /government/revenue/by-category`<br>`GET /government/revenue/defaulters`<br>…and 12 more |
...
| `audit:read` | View | revenue_officer, finance_officer, auditor, admin | `GET /agents/kyc/documents/:id/access`<br>`GET /government/workers`<br>`GET /government/reconciliation/awaiting-settlement`<br>`GET /government/reconciliation/exceptions`<br>…and 13 more |
