...
> because it carries all 3,095 strings; that one is two pages and links back
...
It listed 78 strings. It now lists **3,095 dictionary strings and 30 message
...
3,095 strings is worse than no sheet, because it looks complete; this one cannot
...
- All 3,095 keys exist in both languages; nothing is missing and nothing is spare.
...
- The glossary below is applied consistently across all 3,095 strings: where the
...
3029 strings, grouped by where an agent meets them. Lower stakes
